...
data['defaults'] = [
    ...
    {'name':'veggie supreme', 'toppings':['mozzarella','green_peppers','red_onions','mushrooms','black_olives']},
...
data['open_orders']= [
    {'name':'Peter','confirmation_number':'00001','modality':'pickup','status':'cancelled'},
    {'name':'Peter','confirmation_number':'00002','modality':'pickup','status':'baking'},
